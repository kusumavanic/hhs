$(document).ready(function(){
		...
		$.ajax(
		{
				...
				type:"POST",
				url:"/hhs/rest/pagination/request",
				...
				if(count>5)
				{
						...
						$.ajax({
							type:"GET",
							url:"/hhs/rest/pagination/allreqest?query_id="+query_id+"&start=0&offset=5",
							success:function(data)
							{
								console.log(data);
							...
							$.ajax({
								type:"GET",
								url:"/hhs/rest/pagination/allreqest?query_id="+query_id+"&start="+pageNumber+"&offset=5",
								success:function(data)
								{
									console.log(data);
									$('#listDisplay').html(data);
