...
<html>
	...
	<body>
       ...
       <div class="clearfix"></div>
		...
		<h1>Login</h1></div>
		<hr id="line" >
		<form  action="/hhs/rest/login/consumerlog" method="POST" >
		
		<div class="container">
		<div class="col-md-4 col-md-offset-3">
                	<div class="form-group">		
				<label><b>Enter your email Id</b></label>
				<input type="email" name=email class="form-control" style="border-radius:10px" placeholder="Enter your email Id" required>
			</div></div>
		<div class="col-md-4 col-md-offset-3 ">
                	<div class="form-group">		
				<label><b>Enter your password</b></label>
				<input type="password" name=password class="form-control" style="border-radius:10px" placeholder="Enter password" required>
			</div></div>
			<div class="col-md-4 col-md-offset-3">
