	...
	<body>
	 ...
	 <div  style="float:right;margin-top:67px">
       ...
       <div class="clearfix"></div>
		...
		<h1>Login</h1></div>
		<hr id="line" >
		<form method="POST" action="/hhs/rest/login/check" >
		
		<div class="container">
		<div class="col-md-4 col-md-offset-3">
                	<div class="form-group">		
				<label><b>Enter your User name</b></label>
				<input type="text" name=name class="form-control" style="border-radius:10px" placeholder="Enter your user name" required>
			</div></div>
		<div class="col-md-4 col-md-offset-3 ">
                	<div class="form-group">		
